...
export default function Contacts() {
  const { hasCopied, onCopy } = useClipboard('praveen7523017052@gmail.com');
            ...
            <Stack
              ...
              <Stack
                ...
                <Tooltip
                  ...
                  closeOnClick={false}
                  hasArrow>
                  <Link href="mailto: praveen7523017052@gmail.com" target='_blank'>
                  <IconButton
                    aria-label="email"
                    variant="ghost"
                    size="lg"
                ...
                <Link href="https://github.com/praveen021097" target='_blank'>
                  <IconButton
                    aria-label="github"
                    variant="ghost"
                    size="lg"
                ...
                <Link href="https://twitter.com/Praveenkm97" target='_blank'>
                  <IconButton
                    aria-label="twitter"
                    variant="ghost"
                    size="lg"
                ...
                <Link href="https://www.linkedin.com/in/praveen-kumar-036005184/" target='_blank'>
                  <IconButton
                    aria-label="linkedin"
                    variant="ghost"
                    size="lg"
